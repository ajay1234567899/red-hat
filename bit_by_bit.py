...
def create_output_page(arr):
    ...
    strTable = "<html><body><center><table><tr><th>Number<br></th><br><th>Value</th></tr></center>"
    ...
    strTable = strTable + "</table><br><br><form action='{{ url_for(\"changepriority\") }}' method='POST'><center>which one did you select    <input type='text' name='priority'><br>was it helpful    <input type='text' name='helpful'></center><input type='submit'></form></body></html>"
